#!/usr/bin/perl
	...
	my $stim							= "random-sejnowski-Ord=4.00-Sim=2.00-fD=0.05-sA=80.00-vpD=4.00-epD=3.00-gS=8.00-sS=0.06-vF=200.00-eF=110.00"; # S2,4O,2E,10H, 
