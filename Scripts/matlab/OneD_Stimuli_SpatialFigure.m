...
function OneD_Stimuli_SpatialFigure(trainingStimuliName, testingStimuliName)
    ...
    % Do scatter plot
    [maxPlot, miniPlot yProjectionAxis, scatterAxis, xProjectionAxis] = scatterPlotWithMarginalHistograms(X, Y, 'XTitle', 'Eye Position (deg)', 'YTitle', 'Receptive Field Location (deg)', 'XLim', XLim, 'YLim', YLim, 'Legends', {'Training', 'Testing'}, 'MarkerSize', 4, 'YLabelOffset', -10);
